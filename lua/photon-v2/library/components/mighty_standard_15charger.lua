...
COMPONENT.Elements = {
    ...
    [7] = { "Mesh_static", Vector( 0, -0.15, 0 ), Angle( 0, 0, 0 ), "mighters/mesh/7", DrawMaterial = "photon/common/glow_gradient_a", },
    [8] = { "Mesh_static", Vector( 0, -0.1, 0 ), Angle( 0, 0, 0 ), "mighters/mesh/8", DrawMaterial = "photon/common/glow_gradient_a", },
    [9] = { "Mesh_static", Vector( 0, -0.5, 0 ), Angle( 0, 0, 0 ), "mighters/mesh/9", DrawMaterial = "photon/common/glow_gradient_a", },
    [10] = { "Mesh_static", Vector( 0, -0.5, 0 ), Angle( 0, 0, 0 ), "mighters/mesh/10", DrawMaterial = "photon/common/glow_gradient_a", },
